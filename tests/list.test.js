...
describe('The post with most likes', () => {
    const listWithOneBlog = [
      {
        _id: '5a422aa71b54a676234d17f8',
        title: 'Go To Statement Considered Harmful',
    ...
    test('of bigger list of blogs is calculated right', () => {
...
describe('The author with most posts', () => {
    const listWithOneBlog = [
      {
        _id: '5a422aa71b54a676234d17f8',
        title: 'Go To Statement Considered Harmful',
...
describe('The author with most likes', () => {
    ...
    test('when list has only one blog equals to that author and its likes', () => {
